...
docRouter(router, '/api/sample', function (router) {
    ...
    router.get('/bcast', function (req, res) {
      res.writeHead(200, { 'Content-Type': 'application/json' });
      res.end(JSON.stringify({ hostId: 1111 }));
    },
    {
      id: 'sample_bcast',
      name: 'bcast',
    ...
    router.get('/extern', function (req, res){

        var rootUrl = req.query.rootUrl || 'api/sample';
        ...
        var commands = [
            {
                ...
                method: 'POST',
                usage: 'html bparam',
                example: 'html bparamValue',
                doc: 'sample for an external POST command getting body param',
                params: {
                    "bparam": {
                        "short": "b",
                        "type": "string",
        ...
        var o = { rootUrl: rootUrl, commands: commands };
        res.writeHead(200, { 'Content-Type': 'application/json' });
        res.end(JSON.stringify(o));
    },
        {
           ...
           params: {
             "rootUrl": {
               "short": "r",
               "type": "string",
               "doc": "root url to the api provider",
               "style": "query"
             }
       }
       });
